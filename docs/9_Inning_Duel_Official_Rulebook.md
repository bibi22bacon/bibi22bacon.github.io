...
Printed salaries were generated by a **2-AI draft market** (all start at $1; prices rise when taken early/often and fall when ignored; ranks then mapped to a cap-friendly curve). See `data/SALARY_FORMULA.md` for the ability-based approximation formulas.
